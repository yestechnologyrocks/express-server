...
import TimelineSearchResultsComponenent from "./timelineSearchResultsComponent";
...
class TimelineContainer extends React.Component {
    ...
    submitSearch() {
        ...
        browserHistory.push(`timeline?search=${searchTerms}`);
    }
    ...
    render() {
        ...
        let encodedSearch;
        if (search) {
            encodedSearch = xssFilters.inHTMLData(search);
        }
        ...
        return (
            <div className="timeline-container">
                <div className="timeline-events">
                    ...
                    {
                        encodedSearch &&
                        <TimelineSearchResultsComponenent searchTerms={encodedSearch} events={timelineItems}/>
                    }
                </div>
